...
{
    public static partial class GTweenExtensions
    {
        ...
        public static GTween Tween(
            Tweener<Microsoft.Xna.Framework.Vector2>.Getter getter,
            Tweener<Microsoft.Xna.Framework.Vector2>.Setter setter,
            Tweener<Microsoft.Xna.Framework.Vector2>.Getter to,
            float duration,
            ValidationDelegates.Validation validation
        )
        {
            InterpolationTweenBehaviour tweenBehaviour = new InterpolationTweenBehaviour();
            tweenBehaviour.Add(new XNAVector2Tweener(getter, setter, to, duration, validation));
            return new GTween(tweenBehaviour);
        }
